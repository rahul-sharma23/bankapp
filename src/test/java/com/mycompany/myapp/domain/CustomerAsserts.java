...
public class CustomerAsserts {
    ...
    public static void assertCustomerUpdatableRelationshipsEquals(Customer expected, Customer actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getHomeBranch()).as("check homeBranch").isEqualTo(actual.getHomeBranch()))
            .satisfies(e -> assertThat(e.getAssociatedBranch()).as("check associatedBranch").isEqualTo(actual.getAssociatedBranch()));
    }
}
