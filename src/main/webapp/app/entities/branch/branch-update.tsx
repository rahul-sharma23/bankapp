  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="bankuiApp.branch.home.createOrEditLabel" data-cy="BranchCreateUpdateHeading">
            <Translate contentKey="bankuiApp.branch.home.createOrEditLabel">Create or edit a Branch</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('bankuiApp.branch.name')}
                id="branch-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bankuiApp.branch.address')}
                id="branch-address"
                name="address"
                data-cy="address"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bankuiApp.branch.city')}
                id="branch-city"
                name="city"
                data-cy="city"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bankuiApp.branch.state')}
                id="branch-state"
                name="state"
                data-cy="state"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('bankuiApp.branch.zipCode')}
                id="branch-zipCode"
                name="zipCode"
                data-cy="zipCode"
                type="text"
