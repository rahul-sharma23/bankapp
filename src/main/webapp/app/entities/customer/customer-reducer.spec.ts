...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './customer.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CUSTOMER_LIST actions', async () => {
      const arg = {};
    ...
    it('dispatches FETCH_CUSTOMER actions', async () => {
      const arg = 42666;
    ...
    it('dispatches CREATE_CUSTOMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches UPDATE_CUSTOMER actions', async () => {
      const arg = { id: 456 };
    ...
    it('dispatches PARTIAL_UPDATE_CUSTOMER actions', async () => {
      const arg = { id: 123 };
    ...
    it('dispatches DELETE_CUSTOMER actions', async () => {
      const arg = 42666;
